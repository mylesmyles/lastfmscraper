...
import net.mylesputnam.lastfm.asdf.appconfig.bindings.LastFmApiKey;
import net.mylesputnam.lastfm.asdf.appconfig.bindings.LastFmApiRootUrl;
import net.mylesputnam.lastfm.asdf.appconfig.bindings.LastFmRegisteredTo;
import net.mylesputnam.lastfm.asdf.appconfig.bindings.LastFmRequestDelay;
import net.mylesputnam.lastfm.asdf.appconfig.bindings.LastFmSharedSecretKey;
import net.mylesputnam.lastfm.asdf.appconfig.bindings.PostgresAddress;
import net.mylesputnam.lastfm.asdf.appconfig.bindings.PostgresPort;
import net.mylesputnam.lastfm.asdf.appconfig.bindings.PostgresSchemaName;
import net.mylesputnam.lastfm.asdf.appconfig.bindings.PostgresUserPassword;
import net.mylesputnam.lastfm.asdf.appconfig.bindings.PostgresUsername;
import net.mylesputnam.lastfm.asdf.appconfig.bindings.ScraperUserSeed;
